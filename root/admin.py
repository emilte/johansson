...
class ColorAdmin(base_classes.CustomBaseAdmin, ImportExportActionModelAdmin):
...
class DomainAdmin(base_classes.CustomBaseAdmin, ImportExportActionModelAdmin):
...
class TagGroupAdmin(base_classes.CustomBaseAdmin, ImportExportActionModelAdmin):
...
class TagAdmin(base_classes.CustomBaseAdmin, ImportExportActionModelAdmin):
